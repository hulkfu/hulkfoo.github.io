...
没有永久，如若你以为有，就是你错了该改变了。这可能算是天道的一个表现吧，永久意味着死，而宇宙苍天是为了活才大爆炸的。
...
## 2018-1-3
利用晚上的业余时间，我一定要有序把计算机的基础知识补一下。不要忘了，我也算半路出家。

## 2018-1-9
最近发现做 LeetCode 上了隐，用程序解决算法小问题，比 Dota2 还有意思，而且更有成就感。看着数据结构被巧妙的运用，因为在平时的项目里很能这么有这么细致的构思。

看到自己想不到的方案，真是会为作者打 call，自己大脑也学习了新的回路。目前总结，就是对数组、Hash、Set 等基础数据结构的使用，同时配合着迭代、递归等基础的编程思想。
这是不含杂质的编程，我喜欢！

可能有的程序员会问这有什么用？现实项目中又用不到。对啊，无用才是艺术，君不见书法留空才是讲究。连无用空虚的东西都能研究明白，何况有用的实体呢？
况且在写算法的时候，会对自己使用的编程语言有更深入的了解的。

而且很多题都是根据专门的知识点设计的，在项目中有时会遇不到，但会了就是高手。

我之所以不会算法，是对有些概念还是不理解。比如我对 Hash，平时就用来当作键值对了，却忽略了它 key 唯一这个特性。

我现在的编程能力是对线性的过程处理可以各个顺序击破解决，然后给出结果。
而对于需要时间上给出优化结果的算法，总还是没有习惯性的思路，导致看到问题后不知如何下手，有时连暴力算法都想不出。这也是更高一层的思维，需要练习得来。
过了这个坎，补了这节课，就是别人眼中的大牛了，可见很多人都倒在了算法上。
相信积累到一定程度，就会顿悟！

不只编程，任何事情宏观和微观的都难。而所谓的思路开阔，也是因为见多识广，而非天生。算法，又让我发现了计算机的一个新天地，新的乐趣！东西真是越深入研究才越有意思啊！

## 2018-1-11
为什么说 C 语言是计算机编程的基础呢？因为计算机操作系统就是用它写的，再往下就是汇编了。

C 语言很简单，也很深。用 C 语言，就是学习理解操作系统，这才是重中之重。其它一切的高级语言，不都是要依赖于操作系统吗？如线程同步、进程间通信等，能最大利用上操作系统解决问题才牛逼。而操作系统是在最大的利用硬件。

昨天 12 点刷了一道有意思的 leetcode，大脑竟兴奋的睡不着，那是玩游戏的状态。

## 2018-01-30
概念清晰真的很重要，要不就没有办法进行下一步概念间关系的建立，而且你也不能和人进行有效沟通。

## 2018-01-31
编程只是一种能力，需要具体化到实际的工作上，Web 开发是，自动化测试是，App 开发亦是。但一定要落到实处，否则就是屠龙技。其实编程也就那么点内容，比起它要做的事情。所以，程序员的发展是看它所从编程做的工作。

以要做的事情为主要切入点，而不局限于特定的技术。技术的目的也是把事情高效正确的做对。

每次用编程去完成一个新的领域的任务，就是掌握了一个新的技能，获得了更多的经验，如《魔兽世界》角色，升级还能获得新的天赋。

## 2018-03-12
年轻人的一大特点是干什么都特别急，不知道享受过程，而只为了得到结果。

## 2018-03-13
希望是那么的珍贵，需要小心去呵护。因为一旦没有希望，陷入黑暗，就不知道路在何方了。事业，感情，生活都是如此。

未来的发展往往是因为现在希望的火种，一旦熄灭便让未来没有了变数。

## 2018-03-14
虽然互联网已经进入了巨头时代，独脚兽不是那么容易出现了，但是信息化的浪潮还在如火如荼的进行着，把中小企业信息化改造，从而提高工作效率。
